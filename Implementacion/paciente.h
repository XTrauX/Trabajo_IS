...
public:
  ...
  Paciente(string nombre, string apellidos, int idHistorialMedico, string fechaNacimiento = "99/99/9999", string seguroSalud = "", int direccionPostal = 0, int telefono = 0);
